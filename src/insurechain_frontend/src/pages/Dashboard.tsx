        ...
        <>
            <section>
                <div className="container mx-auto">
                    <h1 className="text-3xl font-bold mb-8 flex justify-center mt-10">Insurance Company</h1>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                        {cards.map((card) => (
                            <div key={card.id} className="bg-white border border-gray-300 dark:border-gray-400 shadow-lg rounded-lg">
                                <div className="p-4 sm:p-6 flex flex-col sm:flex-row items-center">
                                    <img className="w-20 h-20 mr-0 sm:mr-6 rounded-full mb-4 sm:mb-0" src="../../public/images/vector-profile.png" alt="Profile" />
                                    <div>
                                        <h3 className="text-xl font-semibold text-gray-800 dark:text-gray-200 mb-2">{card.name}</h3>
                                ...
                                <div className="p-5 sm:p-6">
                                    <a href="" className="flex flex-col items-center text-blue-500 hover:underline">{card.email}</a>
                                </div>
                            </div>
                        ))}
                    </div>
