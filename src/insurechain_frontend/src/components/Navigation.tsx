      ...
      <div className="h-full px-3 py-4">
        <ul className="space-y-2 font-openSans">
          ...
          <li>
            ...
            >
              <i className="fa-solid fa-user text-black flex-shrink-0 w-5 h-5 group-hover:text-primary"></i>
          ...
          <li>
            ...
            >
              <svg
                className="flex-shrink-0 w-5 h-5 text-black group-hover:text-primary"
                aria-hidden="true"
          ...
          <li>
            <NavLink
              ...
              className="flex items-center p-2 hover:bg-secondary group"
            >
              <i className="fa-solid fa-list-check text-black flex-shrink-0 w-5 h-5 group-hover:text-primary"></i>
              <span className="flex-1 ms-3 whitespace-nowrap text-accent group-hover:text-primary">
                Challenges
              </span>
            </NavLink>
